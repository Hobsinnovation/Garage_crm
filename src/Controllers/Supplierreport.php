...
class Supplierreport {
    ...
    public function generate($user, $expenses, $supplier, $counter, $save = false) {
        ...
        if (!empty($user->parent->logo)) {
            $pdf->Image(document_asset("uploads/logos/".$user->parent->logo), $xPos + 40, $yPos, 160);
        }else{
            $pdf->SetFont('','B',24);
        ...
        $content = '
        <table cellpadding="5" cellspacing="5" style="width:100%;background-color: #07162f;color:#ffffff;">
            <tr>
        ...
        <table style="width:100%;height:30px;border-color:#07162f;"><tr><td></td></tr></table>
