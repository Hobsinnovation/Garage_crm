...
// Support both production domain-root installs and XAMPP/sub-folder installs.
// Example: /UnionStar_CRM_V2/index.php -> route prefix /UnionStar_CRM_V2
$scriptDir = str_replace('\\', '/', dirname($_SERVER['SCRIPT_NAME'] ?? '/index.php'));
$basePrefix = ($scriptDir === '/' || $scriptDir === '.' || $scriptDir === '\\') ? '' : '/' . trim($scriptDir, '/');
...
Router::group(array(
    ...
    Router::group(array(
        ...
        Router::get('/client-statements', 'Clients@statements');
        // Client Statement
        Router::get('/clients/{clientid}/statement', 'Clients@statement', array(
    'as' => 'clientid'
));
        Router::get('/clients/{clientid}/statement/pdf', 'Invoice@renderstatement', array(
    'as' => 'clientid'
));
        // Companies
        ...
        // Plans
        Router::get('/plans', 'Plans@get');
        Router::get('/subscription/payments', 'Plans@payments');
        Router::get('/admin/overview', 'Plans@overview');
        Router::post('/plans/create', 'Plans@create');
        Router::post('/plans/update', 'Plans@update');
        Router::post('/plans/update/view', 'Plans@updateview');
        Router::post('/plans/delete', 'Plans@delete');
        ...
        Router::get('/projects/{projectid}/details', 'Projects@details', array(
            'as' => 'projectid'
        ));
        ...
        // Makes
        Router::get('/settings/makes', 'Makes@get');
        Router::post('/settings/makes/create', 'Makes@create');
        Router::post('/settings/makes/update', 'Makes@update');
        Router::post('/settings/makes/update/view', 'Makes@updateview');
        Router::post('/settings/makes/delete', 'Makes@delete');

        // Models
        Router::get('/settings/make/{makeid}/models/', 'Models@get', array(
            'as' => 'makeid'
        ));
        Router::post('/settings/models/create', 'Models@create');
        Router::post('/settings/models/update', 'Models@update');
        Router::post('/settings/models/update/view', 'Models@updateview');
        Router::post('/settings/models/delete', 'Models@delete');
        ...
        Router::post('/marketing/sendemail', 'Marketing@sendemail');
    ...
    Router::group(array(
        ...
        Router::post('/billing/checkout/form', 'Billing@checkoutform');
