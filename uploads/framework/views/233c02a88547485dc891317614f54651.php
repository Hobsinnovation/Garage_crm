...
<!-- Update XL Modal -->
<div class="modal fade" tabindex="-1" id="update-regular">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                <em class="icon ni ni-cross"></em>
            ...
            <div class="update-holder-regular"></div>
        </div>
    </div>
</div>
    ...
    <div class="modal fade" tabindex="-1" id="sendemail">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="simcy-form" action="<?=  url('Marketing@sendemail') ; ?>" data-parsley-validate="" method="POST" loader="true">
                    <div class="modal-body">
                        <p>Create an Email</p>
                        <div class="row gy-4">
                            <div class="col-sm-12">
