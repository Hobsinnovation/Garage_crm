...
<head>
    ...
    <meta name="description" content="Union Star | Auto Garage Management System">
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="<?=  asset('assets/images/favicon.png') ; ?>">
    <!-- Page Title  -->
    <title>Sign In | Union Star Garage CRM</title>
    <!-- StyleSheets  -->
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access your Garage account using your email and password.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-note-s2 text-center pt-4">  <a href="<?=  url('Auth@getstarted') ; ?>"><strong></strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
