<?php global $s_v_data, $model; ?>
                <form class="simcy-form" action="<?=  url('Models@update') ; ?>" data-parsley-validate="" method="POST" loader="true">
                    <div class="modal-body">
                        <p>Update vehicle Model</p>
                        <div class="row gy-4">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label">Model Name</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-lg" placeholder="Model Name" value="<?=  $model->name ; ?>" name="name" required="">
