<?php global $s_v_data, $projects, $user; ?>
<form class="simcy-form select-input" action="<?=  url('Jobcards@create') ; ?>" data-parsley-validate="" method="POST" loader="true">
    <div class="modal-body">
        <p>Create a job card.</p>
        <div class="row gy-4">
            <div class="col-12">
                <div class="form-group mb-2">
                    <label class="form-label">Select Project</label>
                    <div class="form-control-wrap">
                        <select class="form-control form-control-lg select2-dynamic" name="project" required="">
