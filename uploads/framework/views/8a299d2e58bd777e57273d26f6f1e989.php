        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="<?=  url('Overview@get') ; ?>" class="logo-link">
                    <img class="logo-dark logo-img" src="<?=  asset('assets/images/logo-dark.png') ; ?>" alt="logo">
                </a>
            </div>

            <div class="usa-header-context ml-2">
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    <?php if ($user->parent->subscription_status == "Active" || $user->parent->admin == "Yes") { ?>
                    <?php if ($user->role == "Admin" || $user->role == "Owner" || $user->role == "Manager" || $user->role == "Booking Manager") { ?>
                    <li class="dropdown">
                    ...
                    <li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle mr-n1" data-toggle="dropdown">
                            <div class="user-toggle">
                                <div class="user-avatar sm"><span><?=  mb_substr($user->fname, 0, 1, "UTF-8").mb_substr($user->lname, 0, 1, "UTF-8") ; ?></span></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    <div class="user-avatar"><span><?=  mb_substr($user->fname, 0, 1, "UTF-8").mb_substr($user->lname, 0, 1, "UTF-8") ; ?></span></div>
                                    <div class="user-info">
                            ...
                            <div class="dropdown-inner"><ul class="link-list"><li><a href="<?=  url('Settings@get') ; ?>"><em class="icon ni ni-setting-alt"></em><span>Account Settings</span></a></li></ul></div>
                            <div class="dropdown-inner"><ul class="link-list"><li><a href="<?=  url('Auth@signout') ; ?>"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li></ul></div>
                        </div>
                    </li>
                </ul>
            </div>
