...
<div class="row gy-4">
    ...
    <div class="col-sm-2">
        <div class="form-group">
            ...
            <div class="form-control-wrap">
                <input type="number" class="form-control form-control-lg line-total" placeholder="Total" data-parsley-pattern="^[0-9]\d*(\.\d+)?$" name="total[]" value="<?=  $expense->amount ; ?>" step="0.01" required="" readonly="">
            </div>
        </div>
    </div>
    <div class="col-sm-1">
